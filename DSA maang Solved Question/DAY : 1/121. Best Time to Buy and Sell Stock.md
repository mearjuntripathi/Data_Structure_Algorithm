...
You are given an array prices where `prices[i]` is the price of a given stock on the `i^th^` `i<sup>th</sup>` day.
...
* Finally, the function returns the ans variable.# [121. Best Time to Buy and Sell Stock](https://leetcode.com/problems/best-time-to-buy-and-sell-stock/)
